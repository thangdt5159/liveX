    ...
    <section className="border-b border-white/10">
      <div className="relative border-x border-white/10 md:w-[1488px] w-[90%] mx-auto pt-6 before:bg-cornerTriangle before:w-[12px] before:h-[11px] before:bg-no-repeat before:bg-contain before:-top-[6px] before:-left-[7px] before:absolute before:rotate-180 after:bg-cornerTriangle after:w-[12px] after:h-[11px] after:bg-no-repeat after:bg-contain after:-top-[6px] after:-right-[6px] after:absolute after:rotate-180">
        <Image
          ...
          width={251}
          height={209}
          className="hidden md:absolute m:top-12 md:-left-[100px]"
        />
        <Image
        ...
        <table className="w-full text-center cursor-pointer relative">
          <thead>
            <tr className="uppercase bg-white/5 text-[22px] font-bold">
              {titleData.map((item) => (
                <th className="border-x border-white/10 px-[10px] py-[17px] relative before:absolute before:left-0 before:top-0 before:right-0 before:bottom-0 before:opacity-0 before:bg-gradient-to-r before:from-[#D98639] before:to-[#FF3D00] hover:before:opacity-100 before:transition-all before:duration-500">
